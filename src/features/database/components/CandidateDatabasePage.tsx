...
import { Candidate } from '../../results/types'; // Mudei para results/types
...
const CandidateDatabasePage: React.FC = () => {
    ...
    const filteredCandidates = useMemo(() => {
        return allCandidatesFromStore.filter(candidate => {
            ...
            const idadeMatch = candidate.idade !== undefined && candidate.idade !== null ? candidate.idade >= minIdadeNum && candidate.idade <= maxIdadeNum : true;
